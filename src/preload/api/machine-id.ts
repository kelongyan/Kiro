...
export const machineIdApi = {
  ...
  machineIdGetCurrent: (): Promise<{ success: boolean; machineId?: string; error?: string; requiresAdmin?: boolean; adminRestart?: AdminRestartInfo }> => ipcRenderer.invoke('machine-id:get-current'),
  machineIdSet: (newMachineId: string): Promise<{ success: boolean; machineId?: string; error?: string; requiresAdmin?: boolean; adminRestart?: AdminRestartInfo }> => ipcRenderer.invoke('machine-id:set', newMachineId),
  ...
  machineIdRequestAdminRestart: (): Promise<AdminRestartInfo> => ipcRenderer.invoke('machine-id:request-admin-restart'),
